...
本项目采用多许可证模式，分别覆盖硬件、软件与文档。

<p align="center">
<img src="https://github.com/chirpyjay/BioRec-One/wiki/OSHWA_CN23.svg"  width="270" />
</p>

本项目已通过 [OSHWA](https://oshwa.org/) 认证，为开源硬件项目。

如果本项目及其文档对您有所帮助，欢迎考虑引用：[![DOI](https://zenodo.org/badge/1176123295.svg)](https://doi.org/10.5281/zenodo.19648574)
