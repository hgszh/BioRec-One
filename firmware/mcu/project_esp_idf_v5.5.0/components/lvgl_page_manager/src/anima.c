...
static void translateX_anima_cb(void *var, int32_t v) { lv_obj_set_x(var, v); }

static void translateY_anima_cb(void *var, int32_t v) { lv_obj_set_y(var, v); }
...
static void _pm_slide_appear(lv_pm_anima_data *anima_data) {
    ...
    case LV_PM_ANIMA_SLIDE_LEFT: start_val = width; break;
    case LV_PM_ANIMA_SLIDE_RIGHT:
    default: start_val = -width; break;
    }
    end_val = 0;
    ...
    lv_anim_set_values(&appear_anima, start_val, end_val);
    lv_anim_set_path_cb(&appear_anima, lv_anim_path_ease_out);
    lv_anim_set_time(&appear_anima, 200);
...
static void _pm_slide_disAppear(lv_pm_anima_data *anima_data) {
    ...
    switch (anima_data->options.animation) {
    case LV_PM_ANIMA_SLIDE_LEFT: end_val = -width; break;
    case LV_PM_ANIMA_SLIDE_RIGHT:
    default: end_val = width; break;
    }
    start_val = 0;
    ...
    lv_anim_set_values(&disAppear_anima, start_val, end_val); 
    lv_anim_set_time(&disAppear_anima, 200);
...
void _pm_anima_appear(lv_pm_page_t *pm_page, lv_pm_open_options_t *behavior, lv_pm_anima_complete_cb cb) {
    ...
    case LV_PM_ANIMA_SLIDE_RIGHT: _pm_slide_appear(anima_data); break;
    case LV_PM_ANIMA_POPUP: _pm_popup_appear(anima_data); break;
    default: cb(pm_page, *behavior); break;
    }
}
...
void _pm_anima_disAppear(lv_pm_page_t *pm_page, lv_pm_open_options_t *behavior, lv_pm_anima_complete_cb cb) {
    ...
    switch (behavior->animation) {
    case LV_PM_ANIMA_SLIDE_LEFT:
    case LV_PM_ANIMA_SLIDE_RIGHT: _pm_slide_disAppear(anima_data); break;
    case LV_PM_ANIMA_POPUP: _pm_popup_disAppear(anima_data); break;
    default: cb(pm_page, *behavior); break;
    }
}
