...
enum LV_PM_PAGE_ANIMA {
    LV_PM_ANIMA_NONE = 0,
    LV_PM_ANIMA_SLIDE_LEFT = 1,
    LV_PM_ANIMA_SLIDE_RIGHT = 2,
    LV_PM_ANIMA_SLIDE_SCALE = 3,
    LV_PM_ANIMA_POPUP = 4
};

enum LV_PM_ANIMA_DIR { LV_PM_ANIMA_TOP = 0, LV_PM_ANIMA_RIGHT = 1, LV_PM_ANIMA_BOTTOM = 2, LV_PM_ANIMA_LEFT = 3 };
...
extern uint8_t lv_pm_history_len;

#ifndef LV_PM_PAGE_NUM
#define LV_PM_PAGE_NUM 10
#endif

extern lv_pm_page_t *lv_pm_router[LV_PM_PAGE_NUM];
extern uint8_t lv_pm_history[LV_PM_PAGE_NUM];
