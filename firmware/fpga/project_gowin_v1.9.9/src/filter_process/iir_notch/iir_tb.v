...
module tb_iir_notch;
    ...
    // 参数定义
    parameter integer fs = 3600;  // 采样频率Hz
    parameter integer ts_ns = 13.889;  // 采样周期ns 
    parameter integer N = 2048;  // 每个频点采样点数
    parameter real A = 2.0 ** 22;  // 正弦幅度

    // 扫描参数
    parameter integer f_start = 40;
    parameter integer f_stop = 60;  // 奈奎斯特
